...
\begin{enumerate}[label={K.\arabic*}]
    ...
    \item \label{req:syntax-and-semantics} \textbf{Berücksichtigung der Syntax und Semantik} Die Syntax- und Semantikregeln der einzelnen Diagrammtypen sollen berücksichtigt werden und die Möglichkeit der Verletzung der Regeln soll verhindert werden.
...
% TODO: Ableitung der Layout-Patterns
% - Design Patterns [Maier]
% - Ausrichtung
% - T-Shape für die Hierarchie
% - zentrierter Inhalt
