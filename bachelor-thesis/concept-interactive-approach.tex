...
% TODO: Verweise auf restliche Abschnitt ergänzen!
...
Je nach der Art des Layout-Ereignisses werden in der ersten Phase die Instanzen der expliziten Layout-Patterns unter Berücksichtigung des Inhalts des Diagramms, der instanziierten Layout-Patterns und des aktuellen Layout-Zustandes angepasst, indem:

\begin{itemize}
    \item neue Layout-Patterns erstellt bzw. bestehende  Layout-Patterns gelöscht,
    \item die Referenzen auf Knoten der bestehenden Layout-Patterns erstellt bzw. gelöscht
    \item oder die bestehenden Layout-Patterns variiert werden.
\end{itemize}

Das genaue Verhalten der Anpassung der Layout-Patterns ist von einer konkreten Layout-Engine abhängig, die für den gewählten Diagrammtyp ausgelegt sein soll. Dies wird im Abschnitt X diskutiert und im Abschnitt X werden zwei Beispiele präsentiert.



% zweite Phase
% eindeutige Bestimmung des Layouts durch die Layout-Patterns


%Je nach der Art des Layout-Ereignisses werden  zunächst die instanziierten Layout-Patterns angepasst und anschließend ein neues Layout berechnet.
...
% berechnete Layouts = Positionen für Knoten
% weiteres möglich wie Routen für Kanten (nicht implementiert), Animationen/Übergangsparameter für die Transitionen (nicht implementiert)
% dies wurde in dieser Arbeit aus zeitlichen Gründen jedoch nicht betrachtet
...
% mögliche Layout-Übergänge vom aktuellen Zustand abhängig
...
\subsection{Spezialisierung für Diagrammtypen}
\label{subsec:diagram-types-specialization}
...
% Definition auf einem Meta-Modell, speziell für Layout-Patterns
