...
\begin{enumerate}[label={A.\arabic*}]
    \item \textbf{Einhaltung der Abstände von Elementen} Die Elemente im Diagramm sollen nicht zu nahe aneinander liegen. Insbesondere sollen sich die Knoten nicht überlappen und die Kanten sollen keine Knoten schneiden. Die Abstände und Längen der Kanten sollen optimal gewählt werden, so dass das Diagramm übersichtlich bleibt \cite{Siebenhaller03Automatisches, Ambler05The-Elements}.
    ...
    \item \textbf{Optimale Ausnutzung der Zeichenfläche} Um die Diagramme übersichtlicher zu gestalten, sollen die Knoten im Diagramm ausgewogen verteilt und die Gesamtfläche minimiert werden \cite{EichelbergerSchmid09Guidelines, Siebenhaller03Automatisches}.
