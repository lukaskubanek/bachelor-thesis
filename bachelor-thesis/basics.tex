...
% TODO: kleine Änderungen oder Hervorhebung (Animation)
...
\item
\label{pri:drawing-area-utilization}
\textbf{Optimale Ausnutzung der Zeichenfläche}
Um die Diagramme übersichtlicher zu gestalten, sollen die Knoten im Diagramm ausgewogen verteilt und die Gesamtfläche minimiert werden \cite{EichelbergerSchmid09Guidelines, Siebenhaller03Automatisches}.
...
Verwandte Elemente wie z.B. Pakete, durch Relationen verbundene Elemente, Vererbungshierarchien oder Design-Patterns sollen gruppiert und in der Nähe platziert werden \cite{Eichelberger05Aesthetics, Siebenhaller03Automatisches}. Weiterhin sollen die einzelnen Gruppen und insbesondere die Hierarchien im Diagramm verteilt werden \cite{Eiglsperger04Automatic}.
