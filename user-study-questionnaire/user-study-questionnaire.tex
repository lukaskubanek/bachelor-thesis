...
\question{\bf Verfügen Sie über Kenntnisse der objektorientierten Programmierung? Verstehen Sie Begriffe wie Klasse, Vererbung, Unterklasse und Oberklasse?}
...
\question{\bf Bitte bewerten Sie folgende Aussagen:}
...
\vertikalblockfive{trifft völlig zu}{trifft zu}{teils/teils}{trifft nicht zu}{trifft gar nicht zu}{
    ...
    \blocktextfive{Ich denke, dass ich die Aufgaben auch ohne vorherige Vorstellung der möglichen Aktionen des Prototyps problemlos lösen könnte.}
    \blocktextfive{Ich hatte das Programm die ganze Zeit unter Kontrolle.}
    \blocktextfive{Die auf \enquote{Drag and Drop} basierende Verschiebungsaktion war verständlich.}
    ...
    \blocktextfive{Die Einschränkung der freien Positionierung fand ich irritierend.}
    \blocktextfive{Für mich war jederzeit erkennbar, an welche Stelle ich die angeklickte Klasse verschieben kann.}    
    \blocktextfive{Die automatischen Layout-Updates haben mich in der Erstellung des Diagramms gehindert.}    
    \blocktextfive{Das \underline{Layout} der modellierten Diagramme fand ich ästhetisch ansprechend.}
    \blocktextfive{Ich konnte Fehler, die während der Erfüllung der Aufgaben gemacht wurden, korrigieren.}
...
\question{\bf Welche nicht unterstützte Aktion haben Sie in dem Prototyp vermisst?}
