...
% TODO: Grafik besser machen, eine Linie dem rechten Objekt hinzifügen
\begin{figure}[hbt]
    \centering
    \includegraphics[scale=0.85]{resources/omnigraffle-smart-guides-snap-area}
...
% ohne jegliche semantische Unterstützung
...
% Möglichkeit, Diagramme zu erstellen, die auf keiner festen Syntax basieren!
...
% Wie im Abschnitt \ref{subsubsec:graph-drawing-tools} beschrieben, bietet Graphviz eine Software-Bibliothek an, die in andere Tools eingebunden werden kann.

% \cite[S.43]{Wybrow08Using}
...
% die statischen automatischen Algorithmen in visuellen Editoren sind nicht geeignet [DwyerMarriot08Inter, S.4]
