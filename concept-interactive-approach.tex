%%%
% Interactive Diagram-Specific Approach for Layout of Graph-based Software Diagrams
%%%
...
% Vereinfachung der Diagramme (Agile Modeling) -> Möglichkeiten der Umsetzung von Algorithmen, die nicht so flexibel sein müssen (REQ_COMPL_UML Eichelberger)
